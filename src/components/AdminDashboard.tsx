...
import { STAGES_DATA, DEFAULT_ADMIN } from '../data';
...
import { 
  ...
  Shield, KeyRound, Lock, CheckCircle2, AlertCircle, RefreshCw,
...
export const AdminDashboard: React.FC = () => {
  ...
  const [activeAdminTab, setActiveAdminTab] = useState<'students' | 'security' | 'drive'>('students');
                        ...
                        <tr key={student.id} className="hover:bg-slate-50/80 transition-colors">
                          ...
                          <td className="px-5 py-4 text-right">
                            <button
                              ...
                              className="px-3 py-1.5 rounded-xl border border-slate-200 hover:border-emerald-500 bg-white text-emerald-700 font-bold text-xs hover:bg-emerald-50 transition-all flex items-center gap-1.5 ml-auto cursor-pointer"
                            >
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 sm:p-8 max-w-2xl mx-auto space-y-6">
          ...
          <form onSubmit={handleSaveDriveUrl} className="space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
              <button
                type="button"
                onClick={() => setDriveInput(DEFAULT_DRIVE_FOLDER_URL)}
