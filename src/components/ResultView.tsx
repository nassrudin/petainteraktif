  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-8 print:space-y-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-auto">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-emerald-50/70 p-3.5 rounded-xl text-emerald-950 font-medium italic border border-emerald-200 text-sm min-h-[90px] leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-auto">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-teal-50/70 p-3.5 rounded-xl text-teal-950 font-bold text-sm border border-teal-200 min-h-[90px] leading-relaxed">
              ...
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-slate-50 p-3 rounded-xl text-slate-800 font-medium italic border border-slate-200 leading-relaxed">
              ...
              <div className="space-y-1 text-xs bg-amber-50 p-3 rounded-xl border border-amber-200">
                ...
                <p className="font-bold text-amber-950 italic">"{getStageAnswer(2, 'fear_motto') || '-'}"</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-auto">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-slate-50 p-3.5 rounded-xl text-slate-800 font-medium italic border border-slate-200 min-h-[75px] leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-3.5">
              <div className="space-y-1 text-xs">
                ...
                <div className="bg-slate-50 p-3 rounded-xl text-slate-800 font-medium border border-slate-200 leading-relaxed">
              ...
              <div className="space-y-1 text-xs">
                ...
                <div className="bg-sky-50 p-3 rounded-xl text-sky-950 font-bold border border-sky-200 leading-relaxed">
              ...
              <div className="bg-sky-50 p-3 rounded-xl border border-sky-200 text-xs">
                ...
                <p className="font-semibold text-sky-950 italic">"{getStageAnswer(3, 'giveup_motto') || '-'}"</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-auto">
              ...
              <div className="space-y-2.5 text-xs">
                <div className="flex items-start gap-2.5 bg-blue-50/70 p-3 rounded-xl border border-blue-200">
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-medium mt-0.5 leading-relaxed">{getStageAnswer(4, 'step_1') || 'Belum diisi'}</p>
                  </div>
                </div>
                <div className="flex items-start gap-2.5 bg-blue-50/70 p-3 rounded-xl border border-blue-200">
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-medium mt-0.5 leading-relaxed">{getStageAnswer(4, 'step_2') || 'Belum diisi'}</p>
                  </div>
                </div>
                <div className="flex items-start gap-2.5 bg-blue-50/70 p-3 rounded-xl border border-blue-200">
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-medium mt-0.5 leading-relaxed">{getStageAnswer(4, 'step_3') || 'Belum diisi'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-3.5">
              <div className="space-y-1 text-xs">
                ...
                <div className="bg-slate-50 p-3 rounded-xl text-slate-800 font-bold border border-slate-200">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="bg-blue-50/50 p-3 rounded-xl border border-blue-100">
                  ...
                  <p className="text-slate-800 font-medium leading-relaxed">{getStageAnswer(4, 'consistency_strategy') || '-'}</p>
                </div>
                <div className="bg-blue-50/50 p-3 rounded-xl border border-blue-100">
                  <p className="text-[10px] font-bold text-blue-700 mb-1 block uppercase">Yang Membantu:</p>
                  <p className="text-slate-800 font-medium leading-relaxed">{getStageAnswer(4, 'helper_person') || '-'}</p>
                </div>
              </div>
              ...
              <div className="bg-blue-50 p-3 rounded-xl border border-blue-200 text-xs">
                ...
                <p className="font-semibold text-blue-950 italic leading-relaxed">"{getStageAnswer(4, 'step_done_motto') || '-'}"</p>
              </div>
            </div>
          </div>
        ...
        {/* ========================================================================= */}
        <div className={`ppt-slide aspect-[16/9] w-full bg-slate-50 p-6 sm:p-10 rounded-3xl shadow-xl flex flex-col justify-between border border-slate-200 print:rounded-none print:shadow-none print:border-none print:aspect-[16/9] print:h-screen print:w-screen print:break-after-page ${viewMode === 'slides' && currentSlide !== 6 ? 'hidden' : ''}`}>
          <div className="flex items-center justify-between pb-3 border-b border-slate-200">
            <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-auto">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                ...
                <div className="bg-rose-50 p-3 rounded-xl border border-rose-200">
                  ...
                  <p className="text-slate-800 font-medium leading-relaxed">{getStageAnswer(5, 'destructive_aspect') || '-'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-3.5">
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-indigo-50/70 p-3.5 rounded-xl text-indigo-950 font-medium border border-indigo-200 min-h-[75px] leading-relaxed">
              ...
              <div className="bg-indigo-50 p-3.5 rounded-xl border border-indigo-200 text-xs">
                ...
                <p className="font-bold text-indigo-950 italic leading-relaxed">"{getStageAnswer(5, 'response_strategy') || '-'}"</p>
              </div>
            </div>
          </div>
        ...
        {/* ========================================================================= */}
        <div className={`ppt-slide aspect-[16/9] w-full bg-slate-50 p-6 sm:p-10 rounded-3xl shadow-xl flex flex-col justify-between border border-slate-200 print:rounded-none print:shadow-none print:border-none print:aspect-[16/9] print:h-screen print:w-screen print:break-after-page ${viewMode === 'slides' && currentSlide !== 7 ? 'hidden' : ''}`}>
          <div className="flex items-center justify-between pb-3 border-b border-slate-200">
            <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-auto">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-violet-50/70 p-3.5 rounded-xl text-violet-950 font-bold text-sm border border-violet-200 min-h-[75px] leading-relaxed">
              ...
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-slate-50 p-3.5 rounded-xl text-slate-800 font-medium border border-slate-200 min-h-[75px] leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-emerald-50 p-3.5 rounded-xl text-emerald-950 font-bold text-sm border border-emerald-200 min-h-[85px] leading-relaxed">
        ...
        {/* ========================================================================= */}
        <div className={`ppt-slide aspect-[16/9] w-full bg-slate-50 p-6 sm:p-10 rounded-3xl shadow-xl flex flex-col justify-between border border-slate-200 print:rounded-none print:shadow-none print:border-none print:aspect-[16/9] print:h-screen print:w-screen print:break-after-page ${viewMode === 'slides' && currentSlide !== 8 ? 'hidden' : ''}`}>
          <div className="flex items-center justify-between pb-3 border-b border-slate-200">
            <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-auto">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-emerald-50 p-3.5 rounded-xl text-emerald-950 font-semibold border border-emerald-200 min-h-[75px] leading-relaxed">
              ...
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-amber-50 p-3.5 rounded-xl text-amber-950 font-medium border border-amber-200 min-h-[75px] leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              <div className="space-y-1.5 text-xs">
                ...
                <div className="bg-purple-50/70 p-3.5 rounded-xl text-purple-950 font-medium border border-purple-200 min-h-[75px] leading-relaxed">
        ...
        {/* ========================================================================= */}
        <div className={`ppt-slide aspect-[16/9] w-full bg-slate-50 p-6 sm:p-10 rounded-3xl shadow-xl flex flex-col justify-between border border-slate-200 print:rounded-none print:shadow-none print:border-none print:aspect-[16/9] print:h-screen print:w-screen print:break-after-page ${viewMode === 'slides' && currentSlide !== 9 ? 'hidden' : ''}`}>
          <div className="flex items-center justify-between pb-3 border-b border-slate-200">
            <div className="flex items-center gap-3">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-3.5">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex items-start gap-2 bg-amber-50/70 p-2.5 rounded-xl border border-amber-200">
                  ...
                  <p className="text-slate-800 font-medium leading-relaxed">{getStageAnswer(8, 'target_week_1') || 'Belum diisi'}</p>
                </div>
                <div className="flex items-start gap-2 bg-amber-50/70 p-2.5 rounded-xl border border-amber-200">
                  ...
                  <p className="text-slate-800 font-medium leading-relaxed">{getStageAnswer(8, 'target_week_2') || 'Belum diisi'}</p>
                </div>
                <div className="flex items-start gap-2 bg-amber-50/70 p-2.5 rounded-xl border border-amber-200">
                  ...
                  <p className="text-slate-800 font-medium leading-relaxed">{getStageAnswer(8, 'target_week_3') || 'Belum diisi'}</p>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs flex flex-col justify-between">
              <div className="space-y-2">
                ...
                <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-4 rounded-2xl border-2 border-amber-300 text-xs">
                  <p className="text-xs sm:text-sm font-bold text-amber-950 italic leading-relaxed whitespace-pre-wrap">
        ...
        {/* ========================================================================= */}
        <div className={`ppt-slide aspect-[16/9] w-full bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 p-8 sm:p-12 rounded-3xl shadow-xl flex flex-col justify-between relative overflow-hidden border-4 border-amber-400 print:rounded-none print:shadow-none print:border-4 print:aspect-[16/9] print:h-screen print:w-screen print:break-after-page ${viewMode === 'slides' && currentSlide !== 10 ? 'hidden' : ''}`}>
          ...
          <div className="text-center my-auto space-y-3 relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-xs sm:text-sm font-semibold italic text-amber-950 max-w-xl mx-auto leading-relaxed bg-white/60 backdrop-blur-sm p-3 rounded-2xl border border-amber-200/60">
